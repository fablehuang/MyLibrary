...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/fablehuang/MyLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'fablehuang' => '805248896@qq.com' }
  s.source           = { :git => 'https://github.com/fablehuang/MyLibrary.git', :tag => s.version.to_s }
